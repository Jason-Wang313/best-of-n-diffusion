...
This paper studies that tradeoff with finite Best-of-N laws, diversity diagnostics, scorer alignment diagnostics, and latency-adjusted utility. The experiments are CPU-light by design: controlled samplers isolate mechanisms, learned toy policies test state and 32x32 image conditioning, true epsilon-prediction action diffusion tests faithful DDPM/DDIM sampling, and PushT provides a lightweight simulator benchmark path.
