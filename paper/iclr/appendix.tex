...
PushT & \path{pusht_curves.csv}; \path{pusht_rollouts.csv}; \path{pusht_rollout_metric_effect_cis.csv}; \path{pusht_rollout_metric_seed_aggregate.csv}; \path{pusht_summary.json} & \path{pusht_max_selection.png} \\
\bottomrule
\end{tabular}
\end{table}
